                          ...
                          series: [
                            RadialBarSeries<ChartData, String>(
                              ...
                              dataLabelMapper: (ChartData data, _) =>
                                  data.value!.toPrecision().toString(),
                            )
                          ],
                          tooltipBehavior: TooltipBehavior(enable: true),
                        )),
